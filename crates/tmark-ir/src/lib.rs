...
//! - [`emoji`]: the `gemoji` shortcode table (spec §Emoji and icon
//!   shortcodes), generated by `scripts/gen-emoji.py`.
//! - [`sugar`]: the progress-bar and smart-symbol recognisers the parser
//!   reads and the printer escapes (spec §ProgressBar, Appendix "PyMdownX
...
pub use node::{
    ...
    ListStyle, Math, MathBlock, Meta, Note, OrderedList, Para, Plain, ProgressBar, QuoteKind,
    Quoted, RawBlock, RawInline, Ref, RefItem, Side, SmallCaps, SoftBreak, Space, SpanNode, Str,
    Strikeout, Strong, Subscript, Superscript, Table, TableConfig, Target, Task, Underline, Var,
    SUGAR_FIELDS,
};
