...
pub enum Name {
    ...
    TmarkBraceCloseMore,
    TmarkBraceAfter,
    TmarkBraceAfterArgument,
    TmarkArgumentStart,
    TmarkArgumentInside,
    TmarkReferenceStart,
    TmarkReferenceInside,
    TmarkReferencePandocStart,
    TmarkReferenceFootnoteStart,
    TmarkReferenceCaretStart,
    TmarkDefineStart,
    TmarkDefineAfterMarker,
    TmarkDefineAfterArgument,
    TmarkMathCompatStart,
    TmarkMathCompatOpen,
    TmarkMathCompatInside,
    TmarkMathCompatClose,
    TmarkContainerStart,
    TmarkContainerBeforeSequenceOpen,
    TmarkContainerSequenceOpen,
    TmarkContainerInfoBefore,
    TmarkContainerInfo,
    TmarkContainerAtNonLazyBreak,
    TmarkContainerCloseStart,
    TmarkContainerBeforeSequenceClose,
    TmarkContainerSequenceClose,
    TmarkContainerAfterSequenceClose,
    TmarkContainerContentBefore,
    TmarkContainerContentStart,
    TmarkContainerBeforeContentChunk,
    TmarkContainerContentChunk,
    TmarkContainerAfter,
    TmarkAdmonitionStart,
    TmarkAdmonitionSequence,
    TmarkAdmonitionInfoBefore,
    TmarkAdmonitionInfo,
    TmarkAdmonitionAfter,
    TmarkDefinitionStart,
    TmarkDefinitionBeforeContent,
    TmarkDefinitionContent,
    TmarkDefinitionAfter,
    TmarkBodyAtBreak,
    TmarkBodyInside,
    TmarkBodyFurtherStart,
    TmarkBodyFurtherBegin,
    TmarkBodyFurtherAfter,
    FlowBeforeTmarkContainer,
    FlowBeforeTmarkContainerColon,
...
pub fn call(tokenizer: &mut Tokenizer, name: Name) -> State {
    let func = match name {
        ...
        Name::RawFlowCloseAttrsBefore => construct::raw_flow::close_attrs_before,
        Name::RawFlowCloseAttrs => construct::raw_flow::close_attrs,
        ...
        Name::TextBeforeCitationLabel => construct::text::before_citation_label,
        Name::TextBeforeAttention => construct::text::before_attention,
        ...
        // TMark
        Name::TmarkBraceStart => construct::tmark_brace::start,
        Name::TmarkBraceOpenMore => construct::tmark_brace::open_more,
        Name::TmarkBraceInside => construct::tmark_brace::inside,
        Name::TmarkBraceCloseMore => construct::tmark_brace::close_more,
        Name::TmarkBraceAfter => construct::tmark_brace::after,
        Name::TmarkBraceAfterArgument => construct::tmark_brace::after_argument,
        Name::TmarkArgumentStart => construct::tmark_argument::start,
        ...
        Name::TmarkReferenceFootnoteStart => construct::tmark_reference::footnote_start,
        Name::TmarkReferenceCaretStart => construct::tmark_reference::caret_start,
        ...
        Name::TmarkMathCompatStart => construct::tmark_math_compat::start,
        Name::TmarkMathCompatOpen => construct::tmark_math_compat::open,
        Name::TmarkMathCompatInside => construct::tmark_math_compat::inside,
        Name::TmarkMathCompatClose => construct::tmark_math_compat::close,
        Name::TmarkContainerStart => construct::tmark_container::start,
        Name::TmarkContainerBeforeSequenceOpen => construct::tmark_container::before_sequence_open,
        Name::TmarkContainerSequenceOpen => construct::tmark_container::sequence_open,
        Name::TmarkContainerInfoBefore => construct::tmark_container::info_before,
        Name::TmarkContainerInfo => construct::tmark_container::info,
        Name::TmarkContainerAtNonLazyBreak => construct::tmark_container::at_non_lazy_break,
        Name::TmarkContainerCloseStart => construct::tmark_container::close_start,
        Name::TmarkContainerBeforeSequenceClose => {
            construct::tmark_container::before_sequence_close
        }
        Name::TmarkContainerSequenceClose => construct::tmark_container::sequence_close,
        Name::TmarkContainerAfterSequenceClose => construct::tmark_container::after_sequence_close,
        Name::TmarkContainerContentBefore => construct::tmark_container::content_before,
        Name::TmarkContainerContentStart => construct::tmark_container::content_start,
        Name::TmarkContainerBeforeContentChunk => construct::tmark_container::before_content_chunk,
        Name::TmarkContainerContentChunk => construct::tmark_container::content_chunk,
        Name::TmarkContainerAfter => construct::tmark_container::after,
        Name::TmarkAdmonitionStart => construct::tmark_admonition::start,
        Name::TmarkAdmonitionSequence => construct::tmark_admonition::sequence,
        Name::TmarkAdmonitionInfoBefore => construct::tmark_admonition::info_before,
        Name::TmarkAdmonitionInfo => construct::tmark_admonition::info,
        Name::TmarkAdmonitionAfter => construct::tmark_admonition::after,
        Name::TmarkDefinitionStart => construct::tmark_definition::start,
        Name::TmarkDefinitionBeforeContent => construct::tmark_definition::before_content,
        Name::TmarkDefinitionContent => construct::tmark_definition::content,
        Name::TmarkDefinitionAfter => construct::tmark_definition::after,
        Name::TmarkBodyAtBreak => construct::partial_tmark_body::at_break,
        Name::TmarkBodyInside => construct::partial_tmark_body::inside,
        Name::TmarkBodyFurtherStart => construct::partial_tmark_body::further_start,
        Name::TmarkBodyFurtherBegin => construct::partial_tmark_body::further_begin,
        Name::TmarkBodyFurtherAfter => construct::partial_tmark_body::further_after,
        Name::FlowBeforeTmarkContainer => construct::flow::before_tmark_container,
        Name::FlowBeforeTmarkContainerColon => construct::flow::before_tmark_container_colon,
